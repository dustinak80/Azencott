...
#Get standardized
data_final, stdz_params = cont.get_standardized(data, classification = True, get_params = True)
...
#################  Optimize degree and cost for class 0  ########################
time_SVM0 = {}

mySVM.set_kernel(kernel = 'poly', coef0 = 1)
...
# Manual Tune (degree = 3)
a = time.time()

degree = 3
mySVM.set_kernel(kernel = 'poly', coef0 = 1, degree = degree)
...
#################  Optimize degree and Cost for class 1  #######################
mySVM.set_kernel(kernel = 'poly', coef0 = 1)
time_SVM1 = {}
...
tune1_scores, n_sv1 = mySVM.tune_svm(train_1[cont._test_train__x_columns], 
                                    ...
                                    C=1, random_state = 229, tune = 'C', 
                                    params = [15, 17.5, 20, 22.5, 25, 30, 35, 40], it = 1.1)
...
tune2_scores, n_sv2 = mySVM.tune_svm(train_2[cont._test_train__x_columns], 
                                    ...
                                    C=1, random_state = 229, tune = 'C', 
                                    params = [15, 20, 25, 27.5, 30, 32.5, 35], it = 2.1)
...
coef0 = 1
svm0 = SVM()
svm0.set_kernel(kernel = 'poly', coef0 = coef0, degree = degree)
...
coef0 = 1
svm1 = SVM()
svm1.set_kernel(kernel = 'poly', coef0 = coef0, degree = degree)
...
coef0 = 1
svm2 = SVM()
svm2.set_kernel(kernel = 'poly', coef0 = coef0, degree = degree)

#fit
r_sv2, sv2, y_predict2, score2, conf_int2, dist_hp2, model2 = \
